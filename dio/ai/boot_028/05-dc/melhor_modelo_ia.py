...
def recomendar_modelo(caracteristicas):
  # TODO: Crie uma lista de 'ModeloIA' com suas características pontuadas na descrição:
    modelos = [
      ModeloIA(nome="Claude 3 Sonnet", desempenho=8, velocidade=10, custo=5, capacidades=["Codificação", "Recuperação de informações"]),
      ModeloIA(nome="Claude 3 Haiku", desempenho=7, velocidade=9, custo=6, capacidades=["Velocidade", "Resumo de dados não estruturados"]),
      ModeloIA(nome="Claude 3 Opus", desempenho=9, velocidade=10, custo=5, capacidades=["Pesquisa", "Desenvolvimento Acelerado"])
    ]
