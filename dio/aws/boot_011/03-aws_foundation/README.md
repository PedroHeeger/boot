...
Caso seja necessário acessar o ambiente remotamente, uma alternativa utilizada ao invés do **PuTTY** foi com o comando `ssh -i "G:\Meu Drive\4_PROJ\boot\dio\aws\boot_011\03-aws_foundation\automation\secrets\remoteAccessEc2.pem" ubuntu@ec2-3-80-242-24.compute-1.amazonaws.com`, informando o local do arquivo par de chave `.pem` e o endereço completo da maquina virtual. Observando que o número de IP é separado por traços (`-`) e não por pontos (`.`). Este comando utiliza o software **OpenSSH** para realizar o acesso remoto e pode ser feito diretamente do CLI utilizado, que no caso, foi do **PowerShell**.