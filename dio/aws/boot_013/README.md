# Descubra a Nuvem AWS - Nexa Resources   <img src="./0-aux/logo_boot.png" alt="boot_013" width="auto" height="45">
...
O desenvolvimento deste bootcamp foi dividido em apenas um módulo contendo três cursos e três mentorias. Abaixo é explicado o que foi desenvolvido em cada uma dessas atividades.
...
Neste curso, que também foi teórico, apresentou a cloud da **Amazon Web Services (AWS)**, explicando a infraestrutura, como ela funciona, alguns serviços existentes nesta cloud. Também foi ensinado sobre o funcionamento da rede na AWS e os princípios de regiões e zonas de disponibilidade.