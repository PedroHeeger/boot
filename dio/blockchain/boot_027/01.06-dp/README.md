...
<div style="display: flex; align-items: flex-start; width: 100%;">
    <div style="flex: 1; max-width: 50%; box-sizing: border-box; padding-right: 10px;">
    ...
    <div style="flex: 1; max-width: 50%; box-sizing: border-box; display: flex; justify-content: flex-end; padding-left: 10px;">
