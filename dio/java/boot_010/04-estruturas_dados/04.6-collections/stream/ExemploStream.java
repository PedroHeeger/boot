...
/**
 * Classe para manipulação da estrutura de dados Stream.
 */
public class ExemploStream {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----//-----//-----//-----//-----//-----//-----");
        System.out.println("Exibindo os 5 primeiros números e colocando dentro de um Set:");
        numerosAleatorios.stream().limit(5).collect(Collectors.toSet()).forEach(System.out::println);
        Set<String> numerosAleatorios5Primeiros = numerosAleatorios.stream().limit(5).collect(Collectors.toSet());
        System.out.println(numerosAleatorios5Primeiros);

        System.out.println("-----//-----//-----//-----//-----//-----//-----");
        System.out.println("Transformando esta lista de String em uma lista de números inteiros.");
        ...
        System.out.println("-----//-----//-----//-----//-----//-----//-----");
        System.out.println("Extraindo os números pares e maiores que 2 e coloque em uma lista:");
        ...
        System.out.println("-----//-----//-----//-----//-----//-----//-----");
        System.out.println("Calculando a média dos números: ");
        numerosAleatorios.stream()
        ...
        System.out.println("-----//-----//-----//-----//-----//-----//-----");
        System.out.println("Ignorando os 3 primeiros elementos da lista e imprima o restante:");
